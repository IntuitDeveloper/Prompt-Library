...
"transaction_creation_instructions": {
    ...
    For any REST API calls and OAuth 2.0 authentication, I want to use Intuit official JAVA SDK at: https://central.sonatype.com/search?q=g:com.intuit.quickbooks-online&smo=true with Gradle dependency. Use all the latest versions and best practices for SDK integration. Refer to the official documentation at: https://developer.intuit.com/app/developer/qbo/docs/develop/sdks-and-samples-collections/java/install-the-java-sdk#jar-files and https://developer.intuit.com/app/developer/qbo/docs/develop/authentication-and-authorization/oauth-2.0. Use appropriate methods from SDKs only, do not hallucinate or make up methods that don't exist in the SDK. ",
    "estimate": {
